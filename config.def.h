...
static const char *fonts[]          = { "SF Pro Display:pixelsize=20:antialias=true:autohint=true", "Noto Color Emoji:pixelsize=18" };
static const char normbordercolor[] = "#3F3F3F";
static const char normbgcolor[]     = "#3F3F3F";
static const char normfgcolor[]     = "#DCDCCC";
static const char selbordercolor[]  = "#CEAD8E";
...
#define TAGKEYS(KEY,TAG) \
    ...
    { Mod1Mask|ControlMask,         KEY,      swaptags,       {.ui = 1 << TAG} },
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_minus,  spawn,          SHCMD("transset-df -a --dec .1") },
	{ MODKEY|ControlMask,           XK_equal,  spawn,          SHCMD("transset-df -a --inc .1") },
